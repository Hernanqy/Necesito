...
const businesses: Business[] = [
  {
    name: "FerreterÃƒÂ­a Todo Casa",
    category: "FerreterÃƒÂ­a",
    rating: 4.6,
    address: "Rivadavia 3225, OlavarrÃƒÂ­a",
    distance: 1.2,
    hours: "Lunes a sÃƒÂ¡bados 8:30 a 19:00",
    phone: "2284 42-1234",
    whatsapp: "2284 42-1234",
  },
  {
    name: "FerreterÃƒÂ­a Galarza",
    category: "FerreterÃƒÂ­a",
    rating: 4.3,
    address: "EspaÃƒÂ±a 3103, OlavarrÃƒÂ­a",
    distance: 2.1,
    hours: "Lunes a sÃƒÂ¡bados 8:30 a 19:30",
    phone: "2284 43-5678",
    whatsapp: "2284 43-5678",
  },
  {
    name: "FerreterÃƒÂ­a Industrial",
    category: "FerreterÃƒÂ­a",
    rating: 4.7,
    address: "Alberdi 2800, OlavarrÃƒÂ­a",
    distance: 2.4,
...
const products: Product[] = [
  {
    ...
    price: 25000,
    status: "Disponible",
    business: "FerreterÃƒÂ­a Todo Casa",
    category: "FerreterÃƒÂ­a",
    distance: 1.2,
    address: "Rivadavia 3225, OlavarrÃƒÂ­a",
    hours: "Lunes a sÃƒÂ¡bados 8:30 a 19:00",
  ...
  },
  {
    ...
    business: "FerreterÃƒÂ­a Galarza",
    category: "FerreterÃƒÂ­a",
    distance: 2.1,
    address: "EspaÃƒÂ±a 3103, OlavarrÃƒÂ­a",
    hours: "Lunes a sÃƒÂ¡bados 8:30 a 19:30",
    updated: "hace 1 dÃƒÂ­a",
  },
  {
    id: 3,
    ...
    price: 18500,
    status: "Disponible",
    business: "FerreterÃƒÂ­a Industrial",
    category: "FerreterÃƒÂ­a",
    distance: 2.4,
    address: "Alberdi 2800, OlavarrÃƒÂ­a",
    hours: "Lunes a viernes 8:00 a 18:00",
...
const services: Service[] = [
  {
    id: 1,
    name: "Juan PÃƒÂ©rez",
    specialty: "PlomerÃƒÂ­a general",
    rating: 4.8,
    status: "Disponible hoy",
    business: "Juan PÃƒÂ©rez PlomerÃƒÂ­a",
    category: "PlomerÃƒÂ­a",
    distance: 1.4,
    address: "OlavarrÃƒÂ­a",
    hours: "Lunes a sÃƒÂ¡bados 8:00 a 20:00",
    updated: "hace 1 hora",
  },
  {
    id: 2,
    name: "Servicios LÃƒÂ³pez",
    specialty: "PlomerÃƒÂ­a y gas",
    rating: 4.6,
    status: "Disponible hoy",
    business: "Servicios LÃƒÂ³pez",
    category: "PlomerÃƒÂ­a",
    distance: 2.1,
    address: "OlavarrÃƒÂ­a",
    hours: "Lunes a sÃƒÂ¡bados 8:00 a 19:00",
          ...
          <section className="detail-content">
            ...
            <div className="service-list">
              ...
              <div className="service-tags">
                <span>Ã¢Å“â€œ Reparaciones</span>
                <span>Ã¢Å“â€œ PÃƒÂ©rdidas de agua</span>
                <span>Ã¢Å“â€œ Instalaciones</span>
                <span>Ã¢Å“â€œ Mantenimiento</span>
              </div>
            </div>
          ...
          <section className="results-content">
            ...
            {totalResults === 0 && (
              <div className="empty-state">
                ...
                <h3>Probemos otra bÃƒÂºsqueda</h3>

                <p>
                  PodÃƒÂ©s buscar un producto, un comercio o
                  un servicio.
                </p>
              </div>
            )}
    ...
    <div className="app">
      <main className="home">
        ...
        <section className="hero-search">
          ...
          <h2>
            Ã‚Â¿QuÃƒÂ© <span>necesitÃƒÂ¡s?</span>
          </h2>

          <p className="hero-description">
            EncontrÃƒÂ¡ productos y servicios
            <br />
          ...
          <div className="search-box">
            ...
            <input
              ...
              onKeyDown={handleKeyDown}
              placeholder="EscribÃƒÂ­ lo que buscÃƒÂ¡s..."
              autoFocus
            />
          </div>
          ...
          <button className="location-selector">
            <MapPin size={17} />
            <span>OlavarrÃƒÂ­a</span>
            <span className="location-arrow">Ã¢Å’â€ž</span>
          </button>
        </section>

        <section className="quick-section">
          <div className="quick-heading">
            <h3>BuscÃƒÂ¡ algo rÃƒÂ¡pido</h3>
          </div>
